...
@section ('title', "Job Title Management")
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Job Title Management' }}</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#jobtitles-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.jobtitles.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#jobtitles-table_wrapper').removeClass('form-inline');
