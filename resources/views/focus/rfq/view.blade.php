...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('biller.print_rfq', [$rfq->id, 15, token_validator('', 'rfq' . $rfq->id, true), 1]) }}" class="btn btn-purple btn-sm" target="_blank">
...
{{-- @include('focus.rfq.partials.status_modal') --}}
@endsection