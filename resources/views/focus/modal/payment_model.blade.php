        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="payment" id="bill_payment_1">
                    <div class="row">
                        <div class="col">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control required" placeholder="{{trans('general.total_amount')}}" name="amount" id="remains" value="{{numberFormat($invoice['total']-$invoice['pamnt'])}}" inputMode="numeric">
                                <div class="form-control-position font-small-2 blue"><span class="fa fa-credit-card "></span> {{config('currency.symbol')}}
                                </div>
                            </fieldset>
                        </div>
                        <div class="col">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control required" placeholder="{{trans('general.payment_date')}}" name="payment_date" data-toggle="datepicker">
                    ...
                    <div class="row">
                        <div class="col mb-1"><label for="method">{{trans('general.payment_method')}}</label>
                    ...
                    <div class="row">
                        <div class="col mb-1"><label for="note">{{trans('general.note')}}</label>
                            <input type="text" class="form-control" name="note" placeholder="{{trans('general.note')}}" value="{{ @$words['pay_note']}}">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" class="form-control required" name="bill_id" id="invoiceid" value="{{$invoice['id']}}">
                        ...
                        <button type="button" class="btn btn-primary actionTransaction" data-form="1">{{trans('general.make_payment')}}</button>
