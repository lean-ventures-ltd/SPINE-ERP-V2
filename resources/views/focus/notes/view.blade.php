        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">{{ trans('labels.backend.notes.view') }} 
                        @permission('note-data' )
                            <a href="{{route('biller.notes.edit',[$note['id']])}}" class="btn btn-blue  btn-lighten-3 round">
