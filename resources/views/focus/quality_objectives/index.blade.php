    ...
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-6">
                <h4 class="content-header-title mb-0">Quality Objectives</h4>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <table id="qualityObjectivesTable"
...
@section('after-scripts')
    ...
    <script>
        ...
        const Index = {
            ...
            drawDataTable() {
                $('#qualityObjectivesTable').dataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    stateSave: true,
                    ...
                    ajax: {
                        url: '{{ route('biller.quality-objectives.get') }}',
                        // data: {
                        //     date: this.dateId,
