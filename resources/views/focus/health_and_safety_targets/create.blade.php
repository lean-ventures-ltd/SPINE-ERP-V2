...
@section('title', 'Health And Safety Targets')

@section('content')
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-6">
                <h4 class="content-header-title">{{ 'Health And Safety Targets' }}</h4>
            </div>
            <div class="content-header-right col-6">
                <div class="media width-250 float-right">
                    <div class="media-body media-right text-right">
                        @include('focus.health_and_safety_targets.partials.health-and-safety-targets-header-buttons')
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                {{ Form::open(['route' => 'biller.health-and-safety-targets.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-health-and-safety']) }}
                                @include('focus.health_and_safety_targets.form')
                                <br>
                                {{ link_to_route('biller.health-and-safety-targets.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
...
@section('after-scripts')
    ...
    <script>
        ...
        // });
         $('#year').datepicker('setDate', '{{date(config('core.user_date_format'))}}');
