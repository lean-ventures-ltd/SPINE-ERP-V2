...
@section('extra-scripts')
    ...
    <script>
        ...
        // $("#quoteTbl").on("change", ".qty, .rate, .tax_rate, .buyprice, .estqty, .unit", function() {
        ...
        //         console.log(qty, ' ',buyprice , " ", estqty, " ", rate);
            ...
            return {
                ...
                select: function(event, ui) {
                    ...
                    if (row.hasClass('misc')) {
                        ...
                        // let price = rate * ($('#tax_id').val() / 100 + 1);
                        $('#price-' + i).val(accounting.formatNumber(data.purchase_price, 4));
                        $('#amount-' + i).text(accounting.formatNumber(data.purchase_price, 4));
                        $('#rate-' + i).val(accounting.formatNumber(data.purchase_price, 4));
