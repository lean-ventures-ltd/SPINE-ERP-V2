                ...
                @if (isset($note))
                    <form id="data_form_note" class="todo-input">
                        <div class="modal-header">
                            <h5 class="modal-title" id="AddNoteLabel">Edit Note</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <fieldset class="form-group col-12">
                                    <input type="text" class="new-todo-item form-control required" placeholder="{{trans('general.title')}}" value="{{$note->title}}" name="title">
                                </fieldset>
                            </div>
                            <fieldset class="form-group">
                                <textarea class="new-todo-item form-control summernote required" placeholder="{{trans('tasks.description')}}" rows="6"  name="content">{{strip_tags($note->content)}}</textarea>
                            </fieldset>
                        </div>
                        <input type="hidden" value="{{ route('biller.projects.update_meta') }}" id="action-url_6">
                        <input type="hidden" value="{{ $project->id }}" name="project_id">
                        <input type="hidden" value="{{ $note->id }}" name="object_id">
