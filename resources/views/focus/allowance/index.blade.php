...
@section ('title', 'Allowance & Deductions Category')

@section('page-header')
    <h1>Allowance & Deductions Category</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Allowance & Deductions Category</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#allowances-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.allowances.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#allowances-table_wrapper').removeClass('form-inline');
