            ...
            @if (access()->allow('sale'))
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="ft-file-text"></i> Job Verification</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('biller.quotes.get_verify_quote') }}" data-toggle="dropdown"><i class="ft-list"></i>Manage Verifications</a></li>
                            </ul>
                        </li>
                        @endauth
                        {{-- job valuation --}}
...
{{--        @endif--}}
        ...
        {{-- Client Area Module --}}
        @if ((access()->allow('client-area') && (auth()->user()->business->is_main || auth()->user()->is_tenant)) || auth()->user()->id === 130 || auth()->user()->id === 84)
